...
INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'BREAD_PRICE_DOWN', '鍮??먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'BREAD_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'MALA_SKEWER_PRICE_DOWN', '留덈씪瑗ъ튂 ?먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'MALA_SKEWER_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'JELLY_PRICE_DOWN', '?ㅻ━ ?먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'JELLY_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'TTEOKBOKKI_PRICE_DOWN', '?〓낭???먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'TTEOKBOKKI_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'HAMBURGER_PRICE_DOWN', '?꾨쾭嫄??먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'HAMBURGER_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'ICE_CREAM_PRICE_DOWN', '?꾩씠?ㅽ겕由??먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'ICE_CREAM_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'DAKGANGJEONG_PRICE_DOWN', '??컯???먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'DAKGANGJEONG_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'TACO_PRICE_DOWN', '?肄??먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'TACO_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'HOTDOG_PRICE_DOWN', '?ル룄洹??먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM random_event WHERE event_category = 'HOTDOG_PRICE_DOWN');

INSERT INTO random_event (event_category, event_type, start_time, end_time, population_rate, stock_flat, cost_rate, capital_flat)
SELECT 'BUBBLE_TEA_PRICE_DOWN', '踰꾨툝???먯옱猷?媛寃??섎씫', 'NEXT_DAY', 'SEASON_END', 1.00, 1.00, 0.95, 0 FROM DUAL
