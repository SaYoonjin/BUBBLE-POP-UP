        ...
        >
          ...
          <div className="w-full flex flex-col gap-5">
            <button
              ...
              className="w-full h-[58px] bg-white border-b-4 border-r-2 border-gray-200 hover:border-gray-300 hover:translate-y-[1px] text-cozy-ink rounded-sm flex items-center justify-center gap-3 transition-all shadow-sm font-bold text-[15px] relative overflow-hidden"
            >
            ...
            <button
              ...
              className="w-full h-[58px] bg-[#f0eadd] border-b-4 border-r-2 border-[#d6cfbe] hover:translate-y-[1px] text-cozy-ink rounded-sm flex items-center justify-center gap-3 transition-all shadow-sm font-bold text-[15px] relative overflow-hidden"
            >
